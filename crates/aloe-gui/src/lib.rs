        ...
        Err(payload) => {
            ...
            Json(FullSimulationResponse {
                ...
                sensor_data: GuiSensorData {
                    accel_x: vec![], accel_y: vec![], accel_z: vec![],
                    gyro_x: vec![], gyro_y: vec![], gyro_z: vec![],
                    baro_alt: vec![],
                },
                filter_data: FilterData {
                    est_pos_x: vec![], est_pos_y: vec![], est_pos_z: vec![],
                    est_vel_x: vec![], est_vel_y: vec![], est_vel_z: vec![],
                    est_vel_mag: vec![],
                },
                error_stats: ErrorStats {
                    pos_n_min: 0.0, pos_n_max: 0.0, pos_n_mean: 0.0, pos_n_std: 0.0, pos_n_rmse: 0.0,
                    pos_e_min: 0.0, pos_e_max: 0.0, pos_e_mean: 0.0, pos_e_std: 0.0, pos_e_rmse: 0.0,
                    pos_d_min: 0.0, pos_d_max: 0.0, pos_d_mean: 0.0, pos_d_std: 0.0, pos_d_rmse: 0.0,
                    vel_n_min: 0.0, vel_n_max: 0.0, vel_n_mean: 0.0, vel_n_std: 0.0, vel_n_rmse: 0.0,
                    vel_e_min: 0.0, vel_e_max: 0.0, vel_e_mean: 0.0, vel_e_std: 0.0, vel_e_rmse: 0.0,
                    vel_d_min: 0.0, vel_d_max: 0.0, vel_d_mean: 0.0, vel_d_std: 0.0, vel_d_rmse: 0.0,
                    pos_3d_min: 0.0, pos_3d_max: 0.0, pos_3d_mean: 0.0, pos_3d_std: 0.0, pos_3d_rmse: 0.0,
                },
                success: false,
...
fn run_full_simulation(config: &SimConfig) -> FullSimulationResponse {
    ...
    if config.no_sensors {
        ...
        let error_stats = ErrorStats {
            eskf: EskfErrorStats {
                pos_n_min: 0.0, pos_n_max: 0.0, pos_n_mean: 0.0, pos_n_std: 0.0, pos_n_rmse: 0.0, pos_n_mae: 0.0, pos_n_p95: 0.0,
                pos_e_min: 0.0, pos_e_max: 0.0, pos_e_mean: 0.0, pos_e_std: 0.0, pos_e_rmse: 0.0, pos_e_mae: 0.0, pos_e_p95: 0.0,
                pos_d_min: 0.0, pos_d_max: 0.0, pos_d_mean: 0.0, pos_d_std: 0.0, pos_d_rmse: 0.0, pos_d_mae: 0.0, pos_d_p95: 0.0,
                vel_n_min: 0.0, vel_n_max: 0.0, vel_n_mean: 0.0, vel_n_std: 0.0, vel_n_rmse: 0.0, vel_n_mae: 0.0, vel_n_p95: 0.0,
                vel_e_min: 0.0, vel_e_max: 0.0, vel_e_mean: 0.0, vel_e_std: 0.0, vel_e_rmse: 0.0, vel_e_mae: 0.0, vel_e_p95: 0.0,
                vel_d_min: 0.0, vel_d_max: 0.0, vel_d_mean: 0.0, vel_d_std: 0.0, vel_d_rmse: 0.0, vel_d_mae: 0.0, vel_d_p95: 0.0,
                pos_3d_min: 0.0, pos_3d_max: 0.0, pos_3d_mean: 0.0, pos_3d_std: 0.0, pos_3d_rmse: 0.0, pos_3d_mae: 0.0, pos_3d_p95: 0.0,
                n: 0,
            },
            quantized_flight: QuantizedFlightErrorStats {
                pos_n_min: 0.0, pos_n_max: 0.0, pos_n_mean: 0.0, pos_n_std: 0.0, pos_n_rmse: 0.0, pos_n_mae: 0.0, pos_n_p95: 0.0,
                pos_e_min: 0.0, pos_e_max: 0.0, pos_e_mean: 0.0, pos_e_std: 0.0, pos_e_rmse: 0.0, pos_e_mae: 0.0, pos_e_p95: 0.0,
                alt_min: 0.0, alt_max: 0.0, alt_mean: 0.0, alt_std: 0.0, alt_rmse: 0.0, alt_mae: 0.0, alt_p95: 0.0,
                vel_n_min: 0.0, vel_n_max: 0.0, vel_n_mean: 0.0, vel_n_std: 0.0, vel_n_rmse: 0.0, vel_n_mae: 0.0, vel_n_p95: 0.0,
                vel_e_min: 0.0, vel_e_max: 0.0, vel_e_mean: 0.0, vel_e_std: 0.0, vel_e_rmse: 0.0, vel_e_mae: 0.0, vel_e_p95: 0.0,
                vel_d_min: 0.0, vel_d_max: 0.0, vel_d_mean: 0.0, vel_d_std: 0.0, vel_d_rmse: 0.0, vel_d_mae: 0.0, vel_d_p95: 0.0,
                pos_3d_min: 0.0, pos_3d_max: 0.0, pos_3d_mean: 0.0, pos_3d_std: 0.0, pos_3d_rmse: 0.0, pos_3d_mae: 0.0, pos_3d_p95: 0.0,
            ...
            quant_roundtrip: QuantRoundtripErrorStats {
                pos_n_min: 0.0, pos_n_max: 0.0, pos_n_mean: 0.0, pos_n_std: 0.0, pos_n_rmse: 0.0, pos_n_mae: 0.0, pos_n_p95: 0.0,
                pos_e_min: 0.0, pos_e_max: 0.0, pos_e_mean: 0.0, pos_e_std: 0.0, pos_e_rmse: 0.0, pos_e_mae: 0.0, pos_e_p95: 0.0,
                alt_min: 0.0, alt_max: 0.0, alt_mean: 0.0, alt_std: 0.0, alt_rmse: 0.0, alt_mae: 0.0, alt_p95: 0.0,
                vel_n_min: 0.0, vel_n_max: 0.0, vel_n_mean: 0.0, vel_n_std: 0.0, vel_n_rmse: 0.0, vel_n_mae: 0.0, vel_n_p95: 0.0,
            ...
            quant_recovery: QuantRecoveryErrorStats {
                lat_min: 0.0, lat_max: 0.0, lat_mean: 0.0, lat_std: 0.0, lat_rmse: 0.0, lat_mae: 0.0, lat_p95: 0.0,
                lon_min: 0.0, lon_max: 0.0, lon_mean: 0.0, lon_std: 0.0, lon_rmse: 0.0, lon_mae: 0.0, lon_p95: 0.0,
                alt_min: 0.0, alt_max: 0.0, alt_mean: 0.0, alt_std: 0.0, alt_rmse: 0.0, alt_mae: 0.0, alt_p95: 0.0,
                horiz_min: 0.0, horiz_max: 0.0, horiz_mean: 0.0, horiz_std: 0.0, horiz_rmse: 0.0, horiz_mae: 0.0, horiz_p95: 0.0,
            },
            state_detection: StateDetectionErrorStats {
                burn_min: 0.0, burn_max: 0.0, burn_mean: 0.0, burn_std: 0.0, burn_rmse: 0.0, burn_mae: 0.0, burn_p95: 0.0,
                coast_min: 0.0, coast_max: 0.0, coast_mean: 0.0, coast_std: 0.0, coast_rmse: 0.0, coast_mae: 0.0, coast_p95: 0.0,
                rec_min: 0.0, rec_max: 0.0, rec_mean: 0.0, rec_std: 0.0, rec_rmse: 0.0, rec_mae: 0.0, rec_p95: 0.0,
                n: 0,
            },
        };
