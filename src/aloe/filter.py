...
class FilterConfig:
    ...
    # Each is a list of 4 floats: [pad, burn, coasting, recovery]
    accel_noise_density: list[float] = field(default_factory=lambda: list(ESKF_TUNING_DEFAULTS["accel_noise_density"]))
    gyro_noise_density: list[float] = field(default_factory=lambda: list(ESKF_TUNING_DEFAULTS["gyro_noise_density"]))
    ...
    pos_process_noise: list[float] = field(default_factory=lambda: list(ESKF_TUNING_DEFAULTS["pos_process_noise"]))
    r_gps_pos: list[float] = field(default_factory=lambda: list(ESKF_TUNING_DEFAULTS["r_gps_pos"]))
    r_gps_vel: list[float] = field(default_factory=lambda: list(ESKF_TUNING_DEFAULTS["r_gps_vel"]))
    r_baro: list[float] = field(default_factory=lambda: list(ESKF_TUNING_DEFAULTS["r_baro"]))
    r_mag: list[float] = field(default_factory=lambda: list(ESKF_TUNING_DEFAULTS["r_mag"]))
...
# State label lookup
_STATE_LABELS = ["pad", "burn", "coasting", "recovery"]
...
def run_filter_pipeline(
    ...
    state_names = ["pad", "burn", "coasting", "recovery"]
